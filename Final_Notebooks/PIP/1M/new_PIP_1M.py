...
# df_ratings = df_ratings.head(3)
# df_ratings = df_ratings[[1,2,3,4,5]]
# df_ratings

# df_ratings[1][1] = 1
# df_ratings[2][1] = 1
# df_ratings[3][1] = np.nan
# df_ratings[4][1] = 4
# df_ratings[5][1] = 5

# df_ratings[1][2] = np.nan
# df_ratings[2][2] = 1
# df_ratings[3][2] = 1
# df_ratings[4][2] = 5
# df_ratings[5][2] = 5
...
# df_ratings_dummy = df_ratings_dummy.head(3)
# df_ratings_dummy = df_ratings_dummy[[1,2,3,4,5]]
# df_ratings_dummy[1][1] = 1
# df_ratings_dummy[2][1] = 1
# df_ratings_dummy[3][1] = 0
# df_ratings_dummy[4][1] = 4
# df_ratings_dummy[5][1] = 5

# df_ratings_dummy[1][2] = 0
# df_ratings_dummy[2][2] = 1
# df_ratings_dummy[3][2] = 1
# df_ratings_dummy[4][2] = 5
# df_ratings_dummy[5][2] = 5

# df_ratings_dummy[1][3] = 4
# df_ratings_dummy[2][3] = 0
# df_ratings_dummy[3][3] = 4
# df_ratings_dummy[4][3] = 1
# df_ratings_dummy[5][3] = 2
...
# similarity_matrix = cosine_similarity(df_ratings_dummy, df_ratings_dummy)
# similarity_matrix_df = pd.DataFrame(similarity_matrix, index=similarity_matrix_df.index, columns=similarity_matrix_df.index)
...
print("getting values from DF")
ratings_array = df_ratings.values
# ratings_array = df_ratings_array.values
print("Finished getting values from DF")


from numpy.ma import masked_invalid

print("creating masked array")
ratings_array = masked_invalid(ratings_array)
# masked_array(
...
#   fill_value=1e+20)
print("Finished creating masked array")


print("Calculating agreement")
temp = ratings_array - 2.5
print("Calculating notagreements")
not_agreements = temp[:, None] * temp[None] < 0
# Equivalent to
# from numpy.ma import masked_array
# not_argeements = masked_array([masked_array([(i - 2.5) * (j - 2.5) < 0 for j in ratings_array]) for i in ratings_array])
print("Finished calculating agreement")


print("starting prox calculation!")
dist = np.abs(ratings_array[:, None] - ratings_array[None])
dist[not_agreements] *= 2
prox = ((2 * (rating_max - rating_min) + 1) - dist) ** 2
print("calculated prox!")

print("starting impact calculation!")
temp = np.abs(ratings_array - rating_median) + 1
impact_score = temp[:, None] * temp[None]
impact_score[not_agreements] = 1 / impact_score[not_agreements]
print("calculated impact!")

print("starting pop calculation!")
mu_k = ratings_array.mean(0)
temp = ratings_array - mu_k
shape = ratings_array.shape
...
# This is the matrix from my own slow_ass_method
similarity_matrix_df
...
print("saving the sim_matrix as: new_sim_1M.pkl")
similarity_matrix_df.to_pickle("new_sim_1M.pkl")
print("finished saving the sim_matrix!!!")


# In[13]:


# Read in similarity_matrix from CSV file
output = pd.read_pickle("new_sim_1M.pkl")
output
...
similarity_matrix_df_final_scaled.fillna(0, inplace=True)
...
# Save similarity_matrix_df to CSV file
print("saving the SCALED sim_matrix as: new_sim_scaled_1M.pkl")
similarity_matrix_df_final_scaled.to_pickle("new_sim_scaled_1M.pkl")
print("finished saving the SCALED sim_matrix!!!")
...
print("saving RMSE Values now...")
## convert your array into a dataframe
df = pd.DataFrame(RMSE_values)

## save to xlsx file

filepath = 'RMSE_VALUES.xlsx'
